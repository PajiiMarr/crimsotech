...
export default [
    ...
    route('fallback', 'routes/user/user-fallback.tsx'),
    ...
    route('rate/:orderId/:productId', 'routes/customer/rate.tsx'),
    ...
    ...prefix("seller", [
        ...
        route("seller-product/:productId", "routes/seller/view_product/view_product.tsx"), 
    ...
    ...prefix("admin", [
        ...
        route('riders/:rider_id', 'routes/admin/view_rider/view_rider.tsx'),
