...
export async function loader({ request, context }: Route.LoaderArgs): Promise<LoaderData> {
  ...
  try {
    ...
    const metricsResponse = await AxiosInstance.get('/moderator-vouchers/get_metrics/', {
      params: {
    ...
    const vouchersResponse = await AxiosInstance.get('/moderator-vouchers/vouchers_list/', {
      headers: {
        "X-User-Id": session.get("userId")
      },
      params: {
