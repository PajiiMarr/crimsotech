  ...
  const fetchBoostData = async (start: Date, end: Date) => {
    try {
      ...
      const [metricsResponse, boostsResponse, plansResponse] = await Promise.all([
        AxiosInstance.get('/moderator-boosting/get_metrics/', { params }),
        AxiosInstance.get('/moderator-boosting/get_active_boosts/', { params }),
        AxiosInstance.get('/moderator-boosting/get_boost_plans/', { params })
      ]);
