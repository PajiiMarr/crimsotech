...
export async function loader({ request, context }: Route.LoaderArgs) {
  ...
  try {
    ...
    const analyticsResponse = await AxiosInstance.get(`/moderator-analytics/get_comprehensive_analytics/?${params.toString()}`, {
      headers: {
...
export default function Analytics({ loaderData }: Route.ComponentProps) {
  ...
  const fetchAnalyticsData = async (start: Date, end: Date, rangeType: string) => {
    ...
    try {
      ...
      const response = await AxiosInstance.get(`/moderator-analytics/get_comprehensive_analytics/?${params.toString()}`);
