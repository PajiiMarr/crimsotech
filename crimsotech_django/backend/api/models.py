...
class Delivery(models.Model):
    ...
    pickup_proof = models.ImageField(upload_to='delivery/pickup_proof/', null=True, blank=True)
    delivery_proof = models.ImageField(upload_to='delivery/delivery_proof/', null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
