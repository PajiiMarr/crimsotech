            ...
            {!loading && (growthMetrics.deliveries_growth !== undefined || growthMetrics.earnings_growth !== undefined) && (
              <View style={{ flexDirection: 'row', marginTop: -4, marginBottom: 16 }}>
                {growthMetrics.deliveries_growth !== undefined && (
                  <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: growthMetrics.deliveries_growth >= 0 ? '#ECFDF5' : '#FEF2F2', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6, marginRight: 5 }}>
                    <MaterialIcons
                    ...
                    <Text style={{ fontSize: 11, fontWeight: '600', color: growthMetrics.deliveries_growth >= 0 ? '#059669' : '#DC2626', marginLeft: 4 }}>
                      {growthMetrics.deliveries_growth >= 0 ? '+' : ''}{Number(growthMetrics.deliveries_growth).toFixed(1)}% deliveries
                    </Text>
                  </View>
                )}
                {growthMetrics.earnings_growth !== undefined && (
                  <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: growthMetrics.earnings_growth >= 0 ? '#ECFDF5' : '#FEF2F2', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6, marginLeft: 5 }}>
                    <MaterialIcons
                    ...
                    <Text style={{ fontSize: 11, fontWeight: '600', color: growthMetrics.earnings_growth >= 0 ? '#059669' : '#DC2626', marginLeft: 4 }}>
                      {growthMetrics.earnings_growth >= 0 ? '+' : ''}{Number(growthMetrics.earnings_growth).toFixed(1)}% earnings
                    </Text>
                  </View>
                )}
              </View>
